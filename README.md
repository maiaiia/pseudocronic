...
### AI powered features
- Extract text from a picture (tried to use an OCR but turns out our handwriting is too bad, so this one’s done by an LLM :( — we’re working on getting rid of the API calls in the future)
